...
class CompetitionPolicy
{
    ...
    {
        return $user->can('force_delete_competition');
    }
    ...
    {
        return $user->can('force_delete_any_competition');
    }
    ...
    {
        return $user->can('restore_competition');
    }
    ...
    {
        return $user->can('restore_any_competition');
    }
    ...
    {
        return $user->can('replicate_competition');
    }
    ...
    {
        return $user->can('reorder_competition');
    }
}
